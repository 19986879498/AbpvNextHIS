...
namespace HISInterface.Controllers
{
    ...
    [ApiController]
    public class IPBtesttestController : ControllerBase
    {
        ...
        public IActionResult queryInspectionReport([FromBody] dynamic dy)
        {
            ...
            //} 
            #endregion
            IActionResult result = this.zhyyservice.BindServiceForSql(db, "queryInspectionReport", "IPBtest", res);
            return result;
        }
        /// <summary>
        /// 检查详情查询
        ...
        public IActionResult queryInspectionReportDetails([FromBody] dynamic dy)
        {
            ...
            if (iswsw == "0")
            {
                res = this.zhyyservice.BindServiceForSql(db, "queryInspectionReportDetailsPT", "IPBtest", jObject);
            }
            else if (iswsw == "1")
            {
                res = this.zhyyservice.BindServiceForSql(db, "queryInspectionReportDetailsWSW", "IPBtest", jObject);
            }
            else
            {
        ...
        public IActionResult queryMedicalReport([FromBody] dynamic dy)
        {
            ...
            IActionResult result = this.zhyyservice.BindServiceForSql(db, "queryMedicalReport", "IPBtest", jobj);
            return result;
        ...
        public IActionResult PayInPrepayCost([FromBody] dynamic dy)
        {
            ...
            #endregion
            IActionResult resobj = zhyyservice.BindService(db, "PayInPrepayCost", "IPBtest", j);
